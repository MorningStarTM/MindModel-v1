...
class PPO:
    def __init__(self, config):
        ...
        self.policy = ActorCritic(self.config['state_dim'], self.config['action_dim'], self.config['has_continuous_action_space'], self.config['action_std_init']).to(self.device)
        ...
        self.policy_old = ActorCritic(self.config['state_dim'], self.config['action_dim'], self.config['has_continuous_action_space'], self.config['action_std_init']).to(self.device)
